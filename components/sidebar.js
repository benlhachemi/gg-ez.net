    ...
    return (
        <div className="sidebar w-1/6 h-screen bg-gray-700 justify-center shadow-md py-3 text-center px-2">
            ...
            {user.role === 'admin' &&
                ...
                <Link href='/espace/demandes-inscription'><h1 className="text-white py-3 px-2 rounded-md shadow cursor-pointer my-3 bg-gray-600 hover:bg-gray-800"><AddIcon sx={{fontSize: '20px'}} /> Nouvelle information</h1></Link>
