...
const Brevets = () => {
    ...
    //useEffect HOOKS
    useEffect(() => {
        Axios.get('/api/get-brevets')
        .then(res => {
            setPublications(res.data.brevets)
            setLoading(false)
        })
    }, [])
    ...
    return (
        <div>
            ...
            <div className="w-full text-center">
                <h1 className="text-center text-2xl lg:text-5xl text-gray-100 py-16 font-bold bg-blue-400 mb-10">Brevets</h1>
